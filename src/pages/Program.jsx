      ...
      <div className="program-header">
        ...
        <div className="program-overall">
          ...
          <div className="program-overall__bar">
            <div style={{ width: `${(totalDone / program.length) * 100}%`, height: '100%', background: 'var(--green)', borderRadius: 999 }} />
          </div>
        </div>
      </div>
              ...
              {expanded === i && (
                <div className="lesson-card__body">
                  ...
                  <div className="lesson-card__actions">
                    ...
                    {!item.done && (
                      <button className="btn btn-outline btn-sm" onClick={() => handleMarkDone(item)}>
